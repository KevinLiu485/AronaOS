...
use crate::{task::{processor::current_process, task::TaskRef, yield_task}, timer::current_time, utils::SyscallErr, SyscallRet, PAGE_SIZE_BITS};
...
pub fn futex_get_value_locked(vaddr: VirtAddr) -> SyscallRet {
    ...
    let real_futex_val = unsafe { (vaddr.into::<usize>() as *const u32).read_volatile() };
...
pub fn futex_wait(vaddr: VirtAddr, flags: i32, expected_val: u32, deadline: Option<Duration>, bitset: u32) -> SyscallRet {
...
pub fn futex_wake(vaddr: VirtAddr, flags: i32, nr_waken: u32) -> SyscallRet {
...
pub fn futex_wake_bitset(vaddr: VirtAddr, flags: i32, nr_waken: u32, bitset: u32) -> SyscallRet {
...
pub fn futex_requeue(uaddr: VirtAddr, flags: i32, nr_waken: u32, uaddr2: VirtAddr, nr_requeue: u32) -> SyscallRet {
    let mut ret = 0;
    let mut requeued = 0;
